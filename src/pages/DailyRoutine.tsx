...
const DailyRoutine = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 p-4 relative">
      ...
      <Button
        ...
        className="fixed bottom-6 right-6 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full p-4 shadow-lg hover:scale-105 transition-transform z-50"
      >
        +
      </Button>
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent className="rounded-2xl p-6 bg-white shadow-xl max-w-md w-full">
          <DialogHeader className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-800">Add New Routine</h2>
