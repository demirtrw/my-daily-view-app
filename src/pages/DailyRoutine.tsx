...
import { ArrowLeft, Clock, MapPin, CalendarIcon, X } from "lucide-react";
...
const DailyRoutine = () => {
  ...
  // Returns badge color classes for event types
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 p-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center mb-6 pt-8">
          <Button variant="ghost" size="icon" onClick={() => navigate("/main-menu")} className="mr-3 hover:bg-white/50">
          ...
          <Button
            size="sm"
            className="bg-gradient-to-r from-purple-400 to-pink-400 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200"
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent className="sm:max-w-md w-[95vw] max-h-[90vh] overflow-y-auto bg-white/95 backdrop-blur-sm border-0 shadow-2xl rounded-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition"
            >
              Add Routine
            </Button>
          </form>
